...
Candy case. It ripples the Pibow Candy rainbow from the top
(the side with the HDMI port) to the bottom.

....................

Functions:
- pibow_candy_ripple_6: Ripples the Pibow Candy rainbow
...
def pibow_candy_ripple_6():
    """
    ripples the Pibow Candy rainbow from the top (the side with the
    HDMI port) to the bottom.
    """
