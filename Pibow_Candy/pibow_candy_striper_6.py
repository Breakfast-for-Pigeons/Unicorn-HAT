...
of the Pimoroni Pibow Candy case. It lights them up from the bottom to
the top (the side with the HDMI port), but the order in which each
column lights up is random.

....................

Functions:
- pibow_candy_striper_6: Get the x and y coordinates and the
