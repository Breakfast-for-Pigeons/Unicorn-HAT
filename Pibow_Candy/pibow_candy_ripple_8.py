#!/usr/bin/python3
"""
Pibow Candy Ripple 8

This program displays and the pastel colors of the Pimoroni Pibow
Candy case. It ripples the Pibow Candy rainbow from the bottom to the
top (the side with the HDMI port).
...
def pibow_candy_ripple_8():
    """
    Ripples the Pibow Candy rainbow from the bottom to the top (the side
    with the HDMI port).
    """
