#!/usr/bin/python3
"""
Pibow Candy Striper 4

This program lights up each column one at a time with the pastel colors
of the Pimoroni Pibow Candy case. It lights them up from right to left
(the side with the USB and ethernet ports) and from the bottom
to the top (the side with the HDMI port).

....................

Functions:
- pibow_candy_striper_4: Get the x and y coordinates and the
...
def pibow_candy_striper_4():
    ...
    unicornhat.clear()
    x_coordinate_list = X_OR_Y_COORDINATES[::-1]
    y_coordinate_list = X_OR_Y_COORDINATES[::-1]
