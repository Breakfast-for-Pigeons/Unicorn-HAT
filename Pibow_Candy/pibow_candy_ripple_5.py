...
Candy case. It ripples the Pibow Candy rainbow from the left
(next to the USB and ethernet ports) to the right.

....................

Functions:
- pibow_candy_ripple_5: Ripples the Pibow Candy rainbow
...
def pibow_candy_ripple_5():
    """
    ripples the Pibow Candy rainbow from the left (next to the USB and
    ethernet ports) to the right.
    """
