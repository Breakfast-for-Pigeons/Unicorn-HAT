...
def light_up_random_led(r, g, b):
    unicornhat.set_pixel(random_x_or_y_coordinate(), random_x_or_y_coordinate(), r, g, b)
...
def pibow_candy_sprinkles():
	...
	unicornhat.set_pixel(random_x_or_y_coordinate(), random_x_or_y_coordinate(), 0, 0, 0)
	unicornhat.show()
	time.sleep(0.01)
