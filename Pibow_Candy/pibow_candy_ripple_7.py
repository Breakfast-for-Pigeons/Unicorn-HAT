#!/usr/bin/python3
"""
Pibow Candy Ripple 7

This program displays and the pastel colors of the Pimoroni Pibow
Candy case. It ripples the Pibow Candy rainbow from the right to the
left (next to the USB and ethernet ports).

....................

Functions:
- pibow_candy_ripple_7: Ripples the Pibow Candy rainbow
...
def pibow_candy_ripple_7():
    """
    ripples the Pibow Candy rainbow from the right to the left (next to
