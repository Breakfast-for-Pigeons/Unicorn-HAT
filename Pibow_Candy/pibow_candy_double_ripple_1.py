#!/usr/bin/python3
"""
Pibow Candy Double Ripple 1

This program displays and the pastel colors of the Pimoroni Pibow
Candy case. It ripples the Pibow Candy rainbow from the top left
(The corner near the ethernet port) to the bottom right (diagonal from
the ethernet port) as well as from top (the side with the HDMI port)
to the bottom.
...
def pibow_candy_double_ripple_1():
    ...
    port) as well as from top (the side with the HDMI port) to the
    bottom.
    """
