#!/usr/bin/python3
"""
Pibow Candy Double Ripple 3

This program displays and the pastel colors of the Pimoroni Pibow
Candy case. It ripples the Pibow Candy rainbow from the bottom right
(diagonal from the ethernet port) to the top left (The corner near the
ethernet port) as well as from the bottom to the top (the side  with the
HDMI port).

....................

Functions:
- pibow_candy_double_ripple_3: Ripples the Pibow Candy rainbow
...
def pibow_candy_double_ripple_3():
    """
    Ripples the Pibow Candy rainbow from the bottom right (diagonal from
    the ethernet port) to the top left (The corner near the ethernet port)
    as well as from the bottom to the top (the side with the HDMI port).
    """
