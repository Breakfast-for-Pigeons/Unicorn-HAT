...
of the Pimoroni Pibow Candy case. It lights them up from the top (the
side with the HDMI port) to the bottom, but the order in which each
column lights up is random.

....................

Functions:
- pibow_candy_striper_5: Get the x and y coordinates and the
