#!/usr/bin/python3
"""
Pibow Candy Double Ripple 4

This program displays and the pastel colors of the Pimoroni Pibow
Candy case. It ripples the Pibow Candy rainbow from the bottom left
(next to the USB ports) to the top right (The corner near the power
port) as well as from the bottom to the top (the side with the HDMI
port).

....................

Functions:
- pibow_candy_double_ripple_4: Ripples the Pibow Candy rainbow
...
def pibow_candy_double_ripple_4():
    """
    Ripples the Pibow Candy rainbow from the bottom left (next to the
    USB ports) to the top right (The corner near the power port) as well
    as from the bottom to the top (the side with the HDMI port).
    """
