...
C1 = (227, 11, 93)       # Color 1: Raspberry
C2 = (255, 0, 0)         # Color 2: Red
C3 = (255, 128, 0)       # Color 3: Orange
C4 = (255, 255, 0)       # Color 4: Yellow
C5 = (0, 255, 0)         # Color 5: Green
C6 = (0, 0, 255)         # Color 6: Blue
C7 = (143, 0, 255)       # Color 7: Violet
C8 = (255, 255, 255)     # Color 8: White
C1H = (113, 5, 51)       # Half the values of Color 1
C2H = (128, 0, 0)        # Half the values of Color 2
C3H = (128, 64, 0)       # Half the values of Color 3
C4H = (128, 128, 0)      # Half the values of Color 4
C5H = (0, 128, 0)        # Half the values of Color 5
C6H = (0, 0, 128)        # Half the values of Color 6
